...
plot 'native_libs_ratings.dat' using ($2):($2-$3):($2+$3):xtic(1) lt 1 lc 1 fs solid 0.5 t "Has Native Libs", \
                            '' using ($4):($4-$5):($4+$5):xtic(1) lt 1 lc 0 fs solid 0   t "No Native Libs"
